...
namespace VIZCore3D.NET.NodeDetail
{
    public partial class FrmMain : Form
    {
        ...
        private VIZCore3D.NET.Data.Node node;
        ...
        private void InitializeVIZCore3DCustom()
        {
            vizcore3d.View.SelectionMode = Data.Object3DSelectionOptions.INDIVIDUAL_BOUNDARIES;
        }
        ...
        private void btnSetColor_Click(object sender, EventArgs e)
        {
            ...
            int colorR = Convert.ToInt32(txtColorR.Text);
            int colorG = Convert.ToInt32(txtColorG.Text);
            int colorB = Convert.ToInt32(txtColorB.Text);
        ...
        private void btnMove_Click(object sender, EventArgs e)
        {
            ...
            float x = Convert.ToSingle(txtMoveX.Text);
            float y = Convert.ToSingle(txtMoveY.Text);
            float z = Convert.ToSingle(txtMoveZ.Text);
        ...
        {
            int x = tbRotateX.Value;
            int y = tbRotateY.Value;
            int z = tbRotateZ.Value;
