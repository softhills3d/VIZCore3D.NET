...
namespace VIZCore3D.NET.ClashTest.V2
{
    public partial class FrmMain : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            clash.GroupA = new List<VIZCore3D.NET.Data.Node>() { nodes[0] };
            clash.GroupB = new List<VIZCore3D.NET.Data.Node>() { nodes[1] };
        ...
        private void RefreshTask()
        {
            lvTask.BeginUpdate();
            lvTask.Items.Clear();
            List<VIZCore3D.NET.Data.ClashTest> items = vizcore3d.Clash.Items;
            foreach (VIZCore3D.NET.Data.ClashTest item in items)
            {
                AddTask(item);
            }
            lvTask.EndUpdate();
        ...
        {
            if (lvTask.SelectedItems.Count == 0) return;
        ...
        private void btnPerformInterferenceCheck_Click(object sender, EventArgs e)
        {
            vizcore3d.Clash.PerformInterferenceCheck();
        }
    }
}
