...
namespace VIZCore3D.NET.Disassembly
{
    public partial class FrmMain : Form
    {
        ...
        private void InitializeVIZCore3D()
        {
            ...
            // 심볼 글자 크기
            vizcore3d.Review.Note.SymbolFontSize = Data.FontSizeKind.SIZE10;
            // 심볼 글자 굵게
        ...
        private void SetOption()
        {
            ...
            vizcore3d.Object3D.Disassembly.Target = ckSelectedObject.Checked == false 
                ? VIZCore3D.NET.Manager.DisassemblyManager.TargetKind.ALL 
                : VIZCore3D.NET.Manager.DisassemblyManager.TargetKind.SELECTED;
        }
        ...
        private void btnDisassemble_Click(object sender, EventArgs e)
        {
            ...
            vizcore3d.Object3D.Disassembly.Axis = (VIZCore3D.NET.Manager.DisassemblyManager.AxisKind)cbAxis.SelectedIndex;
            vizcore3d.Object3D.Disassembly.Option = VIZCore3D.NET.Manager.DisassemblyManager.DisassemblyOption.AXIS;
