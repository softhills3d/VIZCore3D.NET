...
{
    public partial class RotateBlockDialog : Form
    {
        // ================================================
        // Attribute & Property
        // ================================================
        ...
        public int AngleX { get { return tbX.Value; } }
        public int AngleY { get { return tbY.Value; } }
        public int AngleZ { get { return tbZ.Value; } }
        ...
        {
            vizcore3d.Object3D.Transform.RestoreTransform(new List<int>() { 0 });
        ...
        private void AddEventHandler(bool enable)
        {
            if (enable == true)
            {
                tbX.Scroll += new System.EventHandler(this.tbX_Scroll);
                tbY.Scroll += new System.EventHandler(this.tbY_Scroll);
                tbZ.Scroll += new System.EventHandler(this.tbZ_Scroll);
            }
            else
            {
                tbX.Scroll -= new System.EventHandler(this.tbX_Scroll);
