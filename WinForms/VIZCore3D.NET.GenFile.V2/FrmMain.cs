...
namespace VIZCore3D.NET.GenFile.V2
{
    public partial class FrmMain : Form
    {
        ...
        // Function
        // ================================================
        private void btnOpenVIZ_Click(object sender, EventArgs e)
        {
        ...
        private void btnOpenGen_Click(object sender, EventArgs e)
        {
            ...
            // Case 3 : Multi File
            /*
            string path1 = "C:\\GENERIC\\BOW-142-2ND_1-6SP.gen";
            string path2 = "C:\\GENERIC\\BOW-142-2ND_1-7SP.gen";
