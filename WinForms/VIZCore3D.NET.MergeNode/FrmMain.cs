...
namespace VIZCore3D.NET.MergeNode
{
    public partial class FrmMain : Form
    {
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            List<VIZCore3D.NET.Data.Node> nodes = vizcore3d.Object3D.FromFilter(VIZCore3D.NET.Data.Object3dFilter.LEAF_ASSEMBLY);
        ...
        private void btnMergeNodes_Click(object sender, EventArgs e)
        {
            ...
            {
                nodes.Add((VIZCore3D.NET.Data.Node)lvNodes.Items[i].Tag);
            }

            if(nodes.Count == 0) return;

            vizcore3d.Object3D.MergeAssembly(nodes, false);
