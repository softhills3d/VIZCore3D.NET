...
namespace VIZCore3D.NET.NearestObjects
{
    public partial class FrmMain : Form
    {
        ...
        private void View_OnViewDefaultMouseUpEvent(object sender, MouseEventArgs e)
        {
            ...
            if (vizcore3d.View.HitTest(e.Location.X, e.Location.Y) == -1)
            {
                lvNodes.Items.Clear();
            ...
            List<VIZCore3D.NET.Data.NearestObjectByAxisPoint> items =
                vizcore3d.GeometryUtility.GetNearestObjects(e.Location.X, e.Location.Y, ckVisibleOnly.Checked, ckOpaqueOnly.Checked);
            ...
            {
                VIZCore3D.NET.Data.Node node = vizcore3d.Object3D.FromIndex(item.Index);
