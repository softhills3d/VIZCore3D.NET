...
namespace VIZCore3D.NET.ProjectionArea
{
    public partial class FrmMain : Form
    {
        ...
        private void btnProjectionXY_Click(object sender, EventArgs e)
        {
            if (vizcore3d.Model.IsOpen() == false) return;
            ProjectionPlane(VIZCore3D.NET.Data.Planes.XY);
        }

        private void btnProjectionYZ_Click(object sender, EventArgs e)
        {
            if (vizcore3d.Model.IsOpen() == false) return;
            ProjectionPlane(VIZCore3D.NET.Data.Planes.YZ);
        }

        private void btnProjectionZX_Click(object sender, EventArgs e)
        {
            if (vizcore3d.Model.IsOpen() == false) return;
