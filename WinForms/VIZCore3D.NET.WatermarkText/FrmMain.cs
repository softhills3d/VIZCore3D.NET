...
namespace VIZCore3D.NET.WatermarkText
{
    public partial class FrmMain : Form
    {
        ...
        private void btnSetWatermark_Click(object sender, EventArgs e)
        {
            ...
            vizcore3d.View.Watermark.Text = txtText.Text.Replace("\\n", "\n");
            vizcore3d.View.Watermark.SetRotate(Convert.ToInt32(txtAngle.Text), VIZCore3D.NET.Data.AngleFormat.DEGREE);
            vizcore3d.View.Watermark.Color = btnTextColor.BackColor;

            vizcore3d.View.Watermark.FontSize = VIZCore3D.NET.Data.FontSize.Size_18;
        ...
        {
            vizcore3d.View.Watermark.Clear();
        }
    }
}
