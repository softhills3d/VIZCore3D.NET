...
namespace VIZCore3D.NET.Camera.CCTV
{
    public partial class FrmMain : Form
    {
        ...
        // Camera Direction
        private CameraDirection CameraDir;

        private bool LoopSync = true;
        ...
        {
            vizcore3d.View.SilhouetteEdge = ckSilhouetteEdge.Checked;
        }

        private void ckRealtimeShadow_CheckedChanged(object sender, EventArgs e)
        {
            vizcore3d.View.RealtimeShadow = ckRealtimeShadow.Checked;
        }

        private void ckShadingEffect_CheckedChanged(object sender, EventArgs e)
        {
            vizcore3d.View.ShadingEffect = ckShadingEffect.Checked;
        }

        private void ckEnvironmentLight_CheckedChanged(object sender, EventArgs e)
        {
            vizcore3d.View.EnvironmentLight = ckEnvironmentLight.Checked;
        }

        private void ckAntiAliasing_CheckedChanged(object sender, EventArgs e)
        {
            vizcore3d.View.AntiAliasing = ckAntiAliasing.Checked;
        }

        private void LoopTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            float degree = 0.3f;
            if (LoopSync == false) return;
        ...
        private void lvList_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            string x = lvList.SelectedItems[0].SubItems[1].Text;
        ...
        {
            EnableLoop(CameraDirection.DOWN);
        }
        ...
        {
            EnableLoop(CameraDirection.LEFT);
        }
        ...
        {
            EnableLoop(CameraDirection.RIGHT);
        }
