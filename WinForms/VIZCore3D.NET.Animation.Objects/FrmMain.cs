...
namespace VIZCore3D.NET.Animation.Objects
{
    public partial class FrmMain : Form
    {
        ...
        private void btnAddStep_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(itx) == true) return;
            if (String.IsNullOrEmpty(ity) == true) return;
            if (String.IsNullOrEmpty(itz) == true) return;
            if (String.IsNullOrEmpty(irx) == true) return;
            if (String.IsNullOrEmpty(iry) == true) return;
            if (String.IsNullOrEmpty(irz) == true) return;
            ...
            if (ntx == 0 && nty == 0 && ntz == 0 && nrx == 0 && nry == 0 && nrz == 0) return;
        ...
        {
            if (lvStep.SelectedItems.Count == 0) return;

            lvStep.Items.Remove(lvStep.SelectedItems[0]);
        }
        ...
        {
            if (lvStep.Items.Count == 0) return false;
            ...
            for (int i = 0; i < lvStep.Items.Count; i++)
            {
                ...
                if (ani.TransformKind == ENUM_TRANSFORM_KIND.NONE) continue;
