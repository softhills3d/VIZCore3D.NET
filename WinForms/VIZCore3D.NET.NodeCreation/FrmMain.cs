...
namespace VIZCore3D.NET.NodeCreation
{
    public partial class FrmMain : Form
    {
        ...
        // Event - Example
        // ================================================
        private void btnNewEmptyModel_Click(object sender, EventArgs e)
        {
            int index = vizcore3d.Model.NewEmptyModel("MODEL");
        }

        private void btnCreateNode100_Click(object sender, EventArgs e)
        {
            vizcore3d.BeginUpdate();
            ...
            for (int i = 0; i < 100; i++)
            {
                VIZCore3D.NET.Data.Node node =
                    vizcore3d.Structure.CreateNode(
                        ...
                        , string.Format("NODE {0}", i + 1)      /* TITLE */
                        );
            }
