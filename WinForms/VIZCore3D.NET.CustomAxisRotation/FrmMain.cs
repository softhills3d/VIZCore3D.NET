...
namespace VIZCore3D.NET.CustomAxisRotation
{
    public partial class FrmMain : Form
    {
        ...
        {
            if (e.Kind != Data.OsnapKind.POINT) return;
        ...
        private void btnShowOsnap_Click(object sender, EventArgs e)
        {
            ...
            vizcore3d.GeometryUtility.ShowOsnap(nodes[0].Index, false, true, false, false);
        }
        ...
        private int angle = 0;
        private List<VIZCore3D.NET.Data.Node> RotationObjects { get; set; }
        ...
        private void timerAnimation_Tick(object sender, EventArgs e)
        {
            ...
            if(RotationObjects == null || RotationObjects.Count == 0)
                RotationObjects = vizcore3d.Object3D.Find.QuickSearch("DOCK_PART_BACK", true);
            ...
            this.Invoke(new Action(delegate ()
            {
                ...
                vizcore3d.Object3D.Transform.Rotate(
                    RotationObjects
                    , new VIZCore3D.NET.Data.Vertex3D(txtV1.Text, ",")
                    , new VIZCore3D.NET.Data.Vertex3D(txtV2.Text, ",")
                    , ++angle
                    );
        ...
        {
            string v1 = txtV1.Text;
            string v2 = txtV2.Text;

            if (String.IsNullOrEmpty(v1) == true) return;
            if (String.IsNullOrEmpty(v2) == true) return;

            string startStr = txtStart.Text;
            string endStr = txtEnd.Text;
