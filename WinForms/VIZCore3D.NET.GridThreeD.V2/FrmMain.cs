...
namespace VIZCore3D.NET.GridThreeD.V2
{
    public partial class FrmMain : Form
    {
        ...
        public VIZCore3D.NET.Data.BoundBox3D BoundBox { get; set; }

        public float Block_Rotate_Angle;

        public VIZCore3D.NET.Data.Node Block { get; set; }

        public VIZCore3D.NET.Data.Vertex3D RotateV1;
        public VIZCore3D.NET.Data.Vertex3D RotateV2;
        ...
        private void btnOpenModel_Click(object sender, EventArgs e)
        {
            ...
            BoundBox = vizcore3d.Model.BoundBox;

            Block = vizcore3d.Object3D.Find.QuickSearch("GRID_S", true)[0];
        }
        ...
        private void AnimationBlock(bool enable)
        {
            if (enable == true)
            {
                Block = vizcore3d.Object3D.Find.QuickSearch("GRID_S", true)[0];
