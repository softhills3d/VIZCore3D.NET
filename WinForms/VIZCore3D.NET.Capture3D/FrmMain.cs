...
namespace VIZCore3D.NET.Capture3D
{
    public partial class FrmMain : Form
    {
        ...
        /// <summary>
        /// VIZCore3D.NET (Mini-View)
        /// </summary>
        private VIZCore3D.NET.VIZCore3DControl vizcore3d_MiniView;
        ...
        private void VIZCore3D_MiniView_OnInitializedVIZCore3D(object sender, EventArgs e)
        {
            // ================================================================
            // License Helper
            // ================================================================
            ...
            if (licenseData == VIZCore3D.NET.Utility.LicenseHelper.LicenseData.SERVER)
            {
                licenseResult = vizcore3d_MiniView.License.LicenseServer(
                    licenseInfo.ContainsKey("LICENSE_IP") == true ? licenseInfo["LICENSE_IP"] : String.Empty
                    , licenseInfo.ContainsKey("LICENSE_PORT") == true ? Convert.ToInt32(licenseInfo["LICENSE_PORT"]) : 8901
                    );
            }
            ...
            {
                licenseResult = vizcore3d_MiniView.License.LicenseFile(
                    licenseInfo.ContainsKey("LICENSE_FILE") == true ? licenseInfo["LICENSE_FILE"] : String.Empty
                    );
            }
            ...
            // ================================================================
            #region 설정 - 툴바
            vizcore3d_MiniView.ToolbarMain.Visible = false;
            vizcore3d_MiniView.ToolbarNote.Visible = false;
            vizcore3d_MiniView.ToolbarMeasure.Visible = false;
            ...
            // 설정 - 상태바
            // ================================================================
            vizcore3d_MiniView.Statusbar.Visible = false;

            vizcore3d_MiniView.View.PreSelect.Enable = false;
            vizcore3d_MiniView.EnableProgressForm = false;
            vizcore3d_MiniView.EnableWaitForm = false;
        }
        #endregion
        ...
        private string GetExportPath()
        {
            ...
            string path = System.IO.Path.Combine(app, "Export");
        ...
        private void lvList_DoubleClick(object sender, EventArgs e)
        {
            ...
            vizcore3d_MiniView.Model.Open(path);
            vizcore3d_MiniView.View.SetCameraData(camera, true);
            vizcore3d_MiniView.View.FitToView();
        }
    }
}
