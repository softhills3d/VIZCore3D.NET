...
namespace VIZCore3D.NET.ModelComparisonSingleMode
{
    public partial class FrmMain : Form
    {
        ...
        {
            vizcore3d.View.ModelComparison.ViewMode = false;
        }
        ...
        private void btnSourceColor_Click(object sender, EventArgs e)
        {
            ...
            dlg.ShowHelp = true;
            dlg.Color = btnSourceColor.BackColor;

            if (dlg.ShowDialog() != DialogResult.OK) return;

            btnSourceColor.BackColor = dlg.Color;
        }
        ...
        private void btnTargetColor_Click(object sender, EventArgs e)
        {
            ...
            dlg.AllowFullOpen = true;
            dlg.ShowHelp = true;
            dlg.Color = btnTargetColor.BackColor;

            if (dlg.ShowDialog() != DialogResult.OK) return;

            btnTargetColor.BackColor = dlg.Color;
        }

        private void ckOriginalSource_CheckedChanged(object sender, EventArgs e)
        {
            vizcore3d.View.ModelComparison.UseOriginalColor(ckOriginalSource.Checked, ckOriginalTarget.Checked);
        }

        private void ckOriginalTarget_CheckedChanged(object sender, EventArgs e)
        {
            vizcore3d.View.ModelComparison.UseOriginalColor(ckOriginalSource.Checked, ckOriginalTarget.Checked);
        }

        private void ShowComparedView(VIZCore3D.NET.Manager.ModelComparisonManager.DisplayType dt)
        {
            vizcore3d.BeginUpdate();

            vizcore3d.View.ModelComparison.SetDisplayColor(Manager.ModelComparisonManager.ColorKind.SOURCE, btnSourceColor.BackColor);
            vizcore3d.View.ModelComparison.SetDisplayColor(Manager.ModelComparisonManager.ColorKind.TARGET, btnTargetColor.BackColor);
            vizcore3d.View.ModelComparison.SetDisplayColor(Manager.ModelComparisonManager.ColorKind.BACKGROUND, btnSourceColor.BackColor);
            vizcore3d.View.ModelComparison.SetDisplayColor(Manager.ModelComparisonManager.ColorKind.SELECTION, btnTargetColor.BackColor);

            vizcore3d.View.ModelComparison.SetDisplayType(dt);

            bool solid = false;
            switch (dt)
            {
                case Manager.ModelComparisonManager.DisplayType.SOLID_OVERLAY:
                    solid = true;
                    break;
                case Manager.ModelComparisonManager.DisplayType.SOLID_OVERLAY_INVERSE:
                    solid = true;
                    break;
                case Manager.ModelComparisonManager.DisplayType.SOLID_FOCUS_DELETE:
                    solid = true;
                    break;
                case Manager.ModelComparisonManager.DisplayType.SOLID_FOCUS_NEW:
                    solid = true;
                    break;
                case Manager.ModelComparisonManager.DisplayType.SOURCE_SOLID_COMPARE_WIRE:
                    break;
                case Manager.ModelComparisonManager.DisplayType.SOURCE_WIRE_COMPARE_SOLID:
                    break;
                case Manager.ModelComparisonManager.DisplayType.SOURCE_WIRE_COMPARE_WIRE:
                    break;
                case Manager.ModelComparisonManager.DisplayType.DT_MAX:
                    break;
                default:
                    break;
            }
            ...
            if (solid == true)
                vizcore3d.View.ModelComparison.SetSolidTransparency(ckSolidTransparency.Checked);
            else
                vizcore3d.View.ModelComparison.SetWireTransparency(ckWireTransparency.Checked);

            vizcore3d.View.ModelComparison.LoadFile(txtPath.Text);

            vizcore3d.EndUpdate();

            vizcore3d.View.ModelComparison.ViewMode = true;
        }

        private void btnSOLID_OVERLAY_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOLID_OVERLAY);
        }

        private void btnSOLID_OVERLAY_INVERSE_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOLID_OVERLAY_INVERSE);
        }

        private void btnSOLID_FOCUS_DELETE_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOLID_FOCUS_DELETE);
        }

        private void btnSOLID_FOCUS_NEW_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOLID_FOCUS_NEW);
        }

        private void btnSOURCE_SOLID_COMPARE_WIRE_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOURCE_SOLID_COMPARE_WIRE);
        }

        private void btnSOURCE_WIRE_COMPARE_SOLID_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOURCE_WIRE_COMPARE_SOLID);
        }

        private void btnSOURCE_WIRE_COMPARE_WIRE_Click(object sender, EventArgs e)
        {
            ShowComparedView(Manager.ModelComparisonManager.DisplayType.SOURCE_WIRE_COMPARE_WIRE);
        }
    }
}
