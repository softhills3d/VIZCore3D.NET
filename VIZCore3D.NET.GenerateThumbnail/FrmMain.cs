...
namespace VIZCore3D.NET.GenerateThumbnail
{
    public partial class FrmMain : Form
    {
        ...
        private void GenerateThumbnail(string[] files)
        {
            ...
            {
                System.Drawing.Image img = vizcore3d.Model.GetModelThumbnail(
                    item
                    , VIZCore3D.NET.Data.CameraDirection.ISO_PLUS
                    , 300
                    , 300
                    );
                ...
                string name = System.IO.Path.GetFileNameWithoutExtension(item).ToUpper();

                ListViewItem lvi = new ListViewItem(name, imageList.Images.Count - 1);
                lvi.Tag = item;
