...
namespace VIZCore3D.NET.Note.V2
{
    public partial class FrmMain : Form
    {
        ...
        private void InitializeVIZCore3DEvent()
        {
            ...
            vizcore3d.OnVIZCore3DKeyDown += Vizcore3d_OnVIZCore3DKeyDown;

            ckEnable.CheckedChanged += CkEnable_CheckedChanged;
        }
        #endregion
        ...
        private void CkEnable_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                vizcore3d.View.Message.Color = Color.Black;
                vizcore3d.View.Message.TextSize = Data.FontSize.Size_16;

                vizcore3d.View.Message.Show(Data.MessageId.ID_01, "표면점을 선택하여 주십시오.", 10, 20);
            }
            else
            {
        ...
        private void Vizcore3d_OnVIZCore3DKeyDown(object sender, Event.EventManager.VIZCoreKeyDownEventArgs e)
        {
        ...
        private void Review_OnReviewChangedEvent(object sender, Event.EventManager.ReviewEventArgs e)
        {
            ...
            switch (e.EventKind)
            {
                ...
                case Manager.ReviewManager.ReviewEventKind.REVIEW_MOVED:
                    log = string.Format("[{0}] 리뷰 위치 변경 : {1} / {2}", (int)e.EventKind, e.ReviewID, vizcore3d.Review.GetItem(e.ReviewID).Kind);
                    break;
                default:
                    break;
            }
